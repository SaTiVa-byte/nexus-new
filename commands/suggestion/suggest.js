//suggest command by ZeroSync Thx :)
...
module.exports = {
  ...
  const embed = new MessageEmbed()
    ...
    const done = new MessageEmbed()
       .setDescription(`<:yes:911653591952003083>  | Your suggestion is Submitted here, <#${channel}>\n\nNote: You agreed to get a DM on a reply over your Suggestion!`)
       .setColor("00FFFF")
    ...
    await msgEmbed.react('<:yes:911653591952003083>')
    await msgEmbed.react('<:no:915570205453848616>')
  }
}